...
LABEL org.opencontainers.image.url="https://github.com/jonzeolla/ai_native_python_demo"
LABEL org.opencontainers.image.source="https://github.com/jonzeolla/ai_native_python_demo/tree/${COMMIT_HASH}"
